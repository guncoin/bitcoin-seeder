...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Guncoin-seeder\n"
...
static const string mainnet_seeds[] = {"seed.guncoin.info", "seed2.guncoin.info", ""};
static const string testnet_seeds[] = {"testnet-seed.guncoin.info",
                                       "testnet-seed2.guncoin.info",
                                       ""};
